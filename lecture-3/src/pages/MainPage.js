...
import _main1 from '../assets/_main1.webp'
import _main2 from '../assets/_main2.webp'
import _main3 from '../assets/_main3.webp'
import _main_items from '../assets/_main-items.webp'
import _main_parts from '../assets/_main-parts.webp'
import _main_styles from '../assets/_main-styles.webp'
	...
	return (
		<div className="MainPage -mt-16">
			...
			<div className="mx-auto">
				<ThreeColumns
					columns={[
						<Card image={main1} webp={_main1}>롱보드는 아주 재밌습니다.</Card>,
						<Card image={main2} webp={_main2}>롱보드를 타면 아주 신납니다.</Card>,
						<Card image={main3} webp={_main3}>롱보드는 굉장히 재밌습니다.</Card>
					]}
				/>
				<TwoColumns
					bgColor={'#f4f4f4'}
					columns={[
						(<picture>
							<source data-srcset={_main_items} type='image/webp'/>
							<img src={main_items} />
						</picture>),
						<Meta
							title={'Items'}
				...
				<TwoColumns
					...
					columns={[
						(<picture>
							<source data-srcset={_main_styles} type='image/webp'/>
							<img src={main_styles} />
						</picture>),
						<Meta
							title={'Riding Styles'}
